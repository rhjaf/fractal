...
void FractalCreator::run(string name){
    ...
    drawFractal();
    writeBitmap("output.bmp");
}


FractalCreator::FractalCreator(int width, int height):m_width(width),m_height(height),m_histogram(new int[Mandlebrot::MAX_ITERATIONS]{0}),
...
void FractalCreator::calculateTotalIterations()
{
    ...
    cout << "Overal total_2: " <<m_total<<endl;
}
...
void FractalCreator::drawFractal()
{
    ...
    for(int y=0;y<m_height;y++){
        for(int x=0;x<m_width;x++){
            ...
            // int iterations =  m_fractal[y*m_width+x]; // for each pixel
...
//                green = pow(255,hue); // less than 255
...
void FractalCreator::calculateRangeTotals()
{
    ...
    cout << "Overal Total_1: "<<overallTotal<<endl;
}
